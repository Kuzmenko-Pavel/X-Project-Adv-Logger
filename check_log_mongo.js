...
if (!db.log.impressions.validate().valid || !db.log.impressions.stats().capped) {
    ...
    db.createCollection('log.impressions', {capped: true, max: 1000000, size: 700000000});
...
if (!db.log.impressions.block.validate().valid || !db.log.impressions.block.stats().capped) {
    ...
    db.createCollection('log.impressions.block', {capped: true, max: 1000000, size: 700000000});
}
else {
